...
<body>
    <input type="text" id="checkinDate" autocomplete="off" placeholder="체크인 날짜">
    <input type="text" id="checkoutDate" autocomplete="off" placeholder="체크아웃 날짜">
    <div id="timeSlots"></div>
    <div id="reservationStatus"></div>
    <button id="reserveButton" class="disabled">예약하기</button> <!-- 예약하기 버튼 추가 -->
